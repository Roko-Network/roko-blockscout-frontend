    ...
    return [
      {
        ...
        icon: <IconSvg name="navigation/transactions" boxSize={ 6 } bgColor="button.solid.bg" borderRadius="base" color="button.solid.text"/>,
      },
      {
      ...
      },
      {
        ...
        icon: <IconSvg name="globe" boxSize={ 6 } bgColor="button.solid.bg" borderRadius="base" color="button.solid.text"/>,
      },
      {
        id: 'tvl' as const,
        ...
        icon: <IconSvg name="lock" boxSize={ 6 } bgColor="button.solid.bg" borderRadius="base" color="button.solid.text"/>,
      },
    ]
