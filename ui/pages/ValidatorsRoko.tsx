...
import type { SubstrateValidator, ClockAttestation } from 'lib/api/services/general/substrateApi';
import { fetchTemporalValidatorQuality, reputationToPercent } from 'lib/api/services/general/temporalMeshRpc';
