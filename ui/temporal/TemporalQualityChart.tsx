  ...
  return (
    ...
    >
      <Flex justifyContent="space-between" alignItems="center" mb={ 3 }>
        <Heading as="h3" fontSize="md" fontFamily="heading" color="heading">
        ...
        <Flex gap={ 3 } alignItems="center">
          ...
          <chakra.span fontSize="sm" fontWeight={ 600 } color="brand.accentText">
        ...
        { displaySamples.length < 2 ? (
          ...
          <Box position="relative" h="120px" overflow="hidden">
            ...
            >
              ...
              <line
                x1="0" y1={ CHART_HEIGHT * 0.25 }
                x2={ CHART_WIDTH } y2={ CHART_HEIGHT * 0.25 }
                stroke="currentColor" strokeOpacity="0.14" strokeWidth="0.5"
              />
              <line x1="0" y1={ CHART_HEIGHT * 0.5 } x2={ CHART_WIDTH } y2={ CHART_HEIGHT * 0.5 } stroke="currentColor" strokeOpacity="0.14" strokeWidth="0.5"/>
              <line
                x1="0" y1={ CHART_HEIGHT * 0.75 }
                x2={ CHART_WIDTH } y2={ CHART_HEIGHT * 0.75 }
                stroke="currentColor" strokeOpacity="0.14" strokeWidth="0.5"
              />
              { /* Area fill */ }
              <path d={ buildAreaPath() } fill="var(--chakra-colors-brand-accent)" opacity="0.16"/>
              { /* Line */ }
              <path d={ buildPath() } fill="none" stroke="var(--chakra-colors-brand-accent)" strokeWidth="3" vectorEffect="non-scaling-stroke"/>
              ...
              { displaySamples.map((s, i) => {
                ...
                return <circle key={ i } cx={ cx } cy={ cy } r="3" fill="var(--chakra-colors-brand-accent)" opacity="0.7"/>;
              }) }
            </svg>
            { /* Y-axis labels */ }
