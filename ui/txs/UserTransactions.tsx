...
import { fetchRecentExtrinsics, formatRoko, truncateHex } from 'lib/api/services/general/substrateApi';
...
import { mergeUserTransactions } from './userTransactions';
import type { UserTransactionActivity } from './userTransactions';
...
const UserTransactions = ({ limit = 50, showSummary = false, showViewAll = false }: Props) => {
  const evmQuery = useApiQuery('general:txs_validated', {
