...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/validators': 'Active validators on the %network_title% network — clock quality, violations, bonding state, and pwROKO activity.',
  '/validators/[id]': 'Validator %id% on the %network_title% network — live clock health, violations, pwROKO activity, and clock attestation.',
  ...
  '/developer/rpc': 'Call substrate and Roko temporal_* RPCs on %network_title%.',
  '/developer/metadata': 'Browse %network_title% runtime metadata: pallets, calls, events, errors, storage, constants.',
