...
const COLOR_YELLOW = 'var(--chakra-colors-yellow-400)';
...
const TEXT_COLOR = 'var(--chakra-colors-white-alpha-900)';
const TEXT_MUTED = 'var(--chakra-colors-white-alpha-500)';
