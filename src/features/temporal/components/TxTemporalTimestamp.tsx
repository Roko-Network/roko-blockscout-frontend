...
import { fetchTemporalBlockMetadata, fetchTemporalTxTimestamp } from 'src/features/temporal/api/temporal-rpc';
...
const TxTemporalTimestamp = ({ txHash, blockNumber }: Props) => {
  ...
  const isLoading = txQuery.isLoading || blockQuery.isLoading;
