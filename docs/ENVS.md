...
| NEXT_PUBLIC_FAUCET_URL | `string` | Canonical external faucet application URL used by ROKO explorer links | - | `https://faucet.roko.network` | `https://faucet.roko.network` | ROKO fork |
